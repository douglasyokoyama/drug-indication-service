...
import { FindByIdDrugIndicationUseCase } from './find-drug-indication.use-case';

describe('FindDrugIndicationUseCase', () => {
  let useCase: FindByIdDrugIndicationUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<FindByIdDrugIndicationUseCase>(
      FindByIdDrugIndicationUseCase,
    );
  });
